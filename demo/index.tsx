...
const MyButton = tag('button', 'color-blue p-sm button', {
  hover: { default: 'color-red', small: 'color-green' },
  focus: 'color-green',
  small: 'fontSize-[10px]',
})
...
render(
  <Wrapper>
    ...
    <MyButton small={true}>I'm smaller...</MyButton>
    <ExtendedButton>I'm extended?! Press me!</ExtendedButton>
    <MyInput value="123" />
  </Wrapper>,
)
